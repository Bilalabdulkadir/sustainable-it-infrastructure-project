    ...
    <div className="min-h-screen bg-[#F9FBF7] text-[#1B4332] flex flex-col font-sans selection:bg-[#76C893]/30 selection:text-[#1B4332]">
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10 space-y-10">
        ...
        <motion.section 
          ...
          className="bg-white border border-gold-muted/35 rounded-[32px] p-8 md:p-10 relative overflow-hidden shadow-[0_16px_48px_rgba(179,146,82,0.06),0_4px_12px_rgba(27,67,50,0.02)]"
        >
        ...
        <section className="space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4 bg-white p-3 rounded-[28px] border border-gold-muted/25 shadow-[0_12px_36px_rgba(179,146,82,0.04),0_4px_12px_rgba(27,67,50,0.02)]">

...
export default function GravatarProfile() {
  ...
  return (
    <div id="gravatar-profile-card" className="bg-white border border-[#1B4332]/10 rounded-[32px] p-6 md:p-8 relative overflow-hidden shadow-[0_16px_48px_rgba(27,67,50,0.03)]">
        ...
        {isDrawerOpen && (
          <>
            ...
            >
              ...
              <div className="p-4 bg-white rounded-[24px] border border-[#1B4332]/10 mb-6 flex gap-4 items-center shadow-sm">
                <img
                  src="https://2.gravatar.com/avatar/0deb964c26e8bc1d216ff99e022efd48536862ac224b34d08545b2cc63d47776?s=256&d=initials"
                  alt="Bilal"
              ...
              <div className="space-y-4 flex-1 overflow-y-auto pr-1">
                {contactItems.map((item) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 p-4 rounded-[20px] border border-[#1B4332]/10 bg-white hover:bg-[#1B4332]/5 hover:border-[#1B4332]/20 transition duration-200 group shadow-sm"
                  >
